...
The search presented in this thesis is one of several ongoing and completed searches for the DH model at the LHC, which target different decay modes of the DH \(s\) that is emitted in the model's LHC signatures shown in Figure \ref{fig:Feynman_DH}. 
