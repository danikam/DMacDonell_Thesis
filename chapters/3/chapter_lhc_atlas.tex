...
The ATLAS trigger is designed to efficiently select the collision events to be read out, processed and saved to offline storage based on a set of criteria applied to preliminary detector information. The trigger system is divided
