...
Since the optimal placement of selections was found to vary to some extent for MC simulated data sets with different \ms and \mZp, the cut placements were initially optimized with the aim of maximizing the average Asimov discovery significance for MC simulated data sets at the following four mass points which cover most of the \ms range considered in the search: (\ms, \mZp) = \{(210, 2100), (285, 1700), (310, 500), (335, 1000)\} GeV. An iterative approach was used which combined:

\begin{itemize}
\item repeated grid searches which scanned \(> 1,000,000\) possible multi-dimensional combinations of cut placements on some or all of the optimized variables to identify combinations which maximized \(Z\), and 
\item visual analysis of N-1 plots and 

 approach testing \(> 1,000,000\) possible cut-combinations were used to achieve this optimization.
