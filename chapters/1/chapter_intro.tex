...
Despite the observable effects of its gravitational interactions at astronomical scales, the scale of gravitational coupling strengths between massive particles is \(\sim30\) orders of magnitude smaller than any of the other three forces of the SM \cite{griffiths_2008}. As a result, gravitational interactions between dark matter and SM particles are far too weak to be observable in particle detectors. Given that there has not yet been any hint of 
