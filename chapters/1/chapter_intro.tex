...
%, and discusses the theoretical and experimental motivation for studying it. 
...
%in the context of existing searches for the Dark Higgs model, emphasizing the importance of facilitating re-interpretations to constrain other models which may be sensitive to the final state probed by the search. 
...
%, placing additional shielding between the fixed target and the detector to reduce the background flux of neutrinos.
