...
Regardless of where particle DM may be first discovered, the detailed final-state information available in particle collision data ensures that colliders will provide an indispensable tool for studying the properties and interactions of the new particle(s).
